    ...
    <div className="bg-[#F2F2F2] p-[15px] zindex">
      <div className="bg-white flex justify-between py-[20px] px-[30px] items-center rounded-t-[20px]">
        ...
        <div className="flex gap-[20px]">
          <Link href={"/address"}>
            <button className="text-[#C81107] flex justify-center px-[15px] py-[8px] text-[16px] font-bold font-Roboto border-[1px] border-[#C81107] rounded-[8px] items-center hover:bg-red hover:text-white">
              View Address
            </button>
          </Link>
          <button
